...
brew install r csvkit nmap python dos2unix netcat git gpg ical-buddy tmux wget mas lastpass-cli bash-completion vagrant-completion ansible tree jq

echo "Installing Brew cask apps"
brew cask install skype firefox keepassx slack wireshark google-chrome iterm2 virtualbox vagrant xquartz r-app
